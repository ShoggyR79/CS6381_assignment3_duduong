...
h8 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub1 -f "output.csv"> sub1.out 2>&1 &
h9 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub2 -f "output.csv"> sub2.out 2>&1 &
h10 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub3 -f "output.csv"> sub3.out 2>&1 &